...
```html
<link rel="stylesheet" href="https://unpkg.com/@waaelg/dga-design-system@0.5.2/dist/style.css" />
<script type="module">
  import 'https://unpkg.com/@waaelg/dga-design-system@0.5.2/dist/index.js'
</script>
```

::: tip Pin the version
The examples pin `@0.5.2` for reproducible, cacheable builds. Use `@latest` to always fetch the newest release, or a range like `@0.5` to get patch updates automatically.
:::
